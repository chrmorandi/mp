...
<div class="meeting-view">
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li class="<?= ($tab=='notes'?'active':'') ?>"><a href="#notes" role="tab" data-toggle="tab"><?= Yii::t('frontend','Messages');?>&nbsp;<span class="glyphicon glyphicon-envelope comment-bubble"></span></a></li>
  </ul>
