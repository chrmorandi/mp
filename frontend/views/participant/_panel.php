...
<div class="panel panel-default">
  ...
  <div class="panel-heading"><div class="row"><div class="col-lg-10 col-md-10 col-xs-10"><h4 class="meeting-view"><?= Yii::t('frontend','Who') ?></h4><span class="hint-text"><?= Yii::t('frontend','add meeting participants') ?></span></div>
