...
steps.push(['#headingWhat bottom','What is your meeting about?','You can customize the <strong>Subject</strong> for your '+title+'. We\'ll use it for the invitation and reminder emails.<p>Click the pencil button to edit the subject.</p>']);
steps.push(['#headingWho bottom','Who would you like to invite?','You can add one person or a group of people to your '+title+'. <p>Click the person button to add participants.</p>']);
...
if ($('#headingActivity').length>0) {
  steps.push(['#headingActivity bottom','What do you want to do?','You can suggest one or more activity ideas. With multiple ideas, your participants can help you select their favorite. <p>Click the plus button to suggest activities.</p>']);
}
