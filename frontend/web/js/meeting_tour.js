...
switch (mode) {
  case 'planning':
    ...
    steps.push(['.virtualThing right','Is this a virtual meeting?','Switch between <em>in person</em> and <em>virtual</em> '+title+'s such as phone calls or online conferences.']);
