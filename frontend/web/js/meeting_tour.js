...
steps.push(['.nav-tabs top','Welcome','Allow me to show you how to plan '+title+'s. <p>If you prefer, you can <a href="javascript::return false;" onclick="turnOffGuide();">turn off this guide</a>.<br /><br />']);
...
steps.push(['#actionSend top','Sending invitations','Scheduling is collaborative. If you add multiple times and places, you can invite participants to share their favorites. <em>A place isn\'t necessary for virtual '+title+'\s.</em>']);
steps.push(['#actionFinalize top','Finalizing the plan','Or, if you select just one time and place, you can complete the plan. We\'ll email the invitations and setup reminders.']);
