    ...
    <center>
      ...
      <tr>
        <td class="button">
          ...
          <![endif]--><a class="button-mobile" href="http://replace-link-view.com"
...
<!--
 echo \Yii::$app->view->renderFile('@common/mail/section-footer-dynamic.php',['links'=>$links]) -->
