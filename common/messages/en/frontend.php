...
return [
    '' => '',
    'He pitched the idea of a ' => 'He pitched the idea of a',
    'and his advisors Alex Knight and Alex Makarov.' => 'and his advisors Alex Knight and Alex Makarov.',
    'broad assistance from the open source development community' => 'broad assistance from the open source development community',
    'building your own startup series' => 'building your own startup series',
    'diagnosis of a brain tumor' => 'diagnosis of a brain tumor',
    'in 2015, he put the project on hold indefinitely. By 2016, he had resumed development. He\'s built Meeting Planner as a solo startup with ' => 'in 2015, he put the project on hold indefinitely. By 2016, he had resumed development. He\'s built Meeting Planner as a solo startup with',
    'send him a message' => 'send him a message',
    'to Envato Tuts+ in August 2014. After ' => 'to Envato Tuts+ in August 2014. After',
    ' for more than 7 years, its representative in ' => '@@for more than 7 years, its representative in@@',
    ...
    'Alex is one of the core maintainers of ' => '@@Alex is one of the core maintainers of@@',
    'Automatically added to your calendar' => '@@Automatically added to your calendar@@',
    'Captcha' => '@@Captcha@@',
    'Choose times and places together. Make planning easy.' => '@@Choose times and places together. Make planning easy.@@',
    'Choose times and places without all the emails.' => '@@Choose times and places without all the emails.@@',
    ...
    'Decide the date and time for your {mtg_singular}' => '@@Decide the date and time for your {mtg_singular}@@',
    'Decide the place for your {mtg_singular}' => '@@Decide the place for your {mtg_singular}@@',
    'Easily choose time and place' => '@@Easily choose time and place@@',
    'Easily suggest places' => '@@Easily suggest places@@',
    'Easily suggest times' => '@@Easily suggest times@@',
    'Envato Tuts+ Building a Startup series' => '@@Envato Tuts+ Building a Startup series@@',
    'Facebook' => '@@Facebook@@',
    'Finalize the Activity' => '@@Finalize the Activity@@',
    'Finalize the Place' => '@@Finalize the Place@@',
    'Finalize the Time' => '@@Finalize the Time@@',
    'Google' => '@@Google@@',
    'He\'s also written the' => '@@He\'s also written the@@',
    'He\'s also written the ' => '@@He\'s also written the@@',
    'If you prefer, you can' => '@@If you prefer, you can@@',
    'Impeachment Party Scheduling Results' => '@@Impeachment Party Scheduling Results@@',
    'It will help us keep the trolls out and allows you to schedule future social and business events using our collaborative planning service.' => '@@It will help us keep the trolls out and allows you to schedule future social and business events using our collaborative planning service.@@',
    ...
    'Learn more about him here' => '@@Learn more about him here@@',
    'LinkedIn' => '@@LinkedIn@@',
    'Login Now' => '@@Login Now@@',
    'No messages yet.' => '@@No messages yet.@@',
    'No more emails about which times will work best. Suggest one or more that work for your schedule in seconds and we\'ll ask participants about their availability.' => '@@No more emails about which times will work best. Suggest one or more that work for your schedule in seconds and we\'ll ask participants about their availability.@@',
    ...
    'Suggest dates and times' => '@@Suggest dates and times@@',
    'Suggest places' => '@@Suggest places@@',
    'There was a problem with your planning day.' => '@@There was a problem with your planning day.@@',
    'Type or paste in the email address of people to invite. You can also share the invitation link via email or post on Facebook. When you\'re ready to send the invitation, we\'ll deliver it for you.' => '@@Type or paste in the email address of people to invite. You can also share the invitation link via email or post on Facebook. When you\'re ready to send the invitation, we\'ll deliver it for you.@@',
    'Wait for the Official Launch' => '@@Wait for the Official Launch@@',
    'We deliver the invitations' => '@@We deliver the invitations@@',
    ...
    'We\'ll email your invitations' => '@@We\'ll email your invitations@@',
    'What' => '@@What@@',
    'When you\'re ready, finalize the time and location in seconds. You can also allow invitees to make the choices or designate additional organizers.' => '@@When you\'re ready, finalize the time and location in seconds. You can also allow invitees to make the choices or designate additional organizers.@@',
    'Whether you are meeting with one, several or many people, {site-title} make it easy. You can also share the invitation link via email or post on Facebook.' => '@@Whether you are meeting with one, several or many people, {site-title} make it easy. You can also share the invitation link via email or post on Facebook.@@',
    'You can also invite participants by sharing' => '@@You can also invite participants by sharing@@',
    'You can also share the invitation link via email or post on Facebook. Whether you are meeting with one, several or many people, {site-title} makes it easy. ' => '@@You can also share the invitation link via email or post on Facebook. Whether you are meeting with one, several or many people, {site-title} makes it easy.@@',
    'about' => '@@about@@',
    'about building Meeting Planner' => '@@about building Meeting Planner@@',
    ...
    'blog' => '@@blog@@',
    'features' => '@@features@@',
    'participant of various other OpenSource projects.' => '@@participant of various other OpenSource projects.@@',
    'preview' => '@@preview@@',
    'privacy' => '@@privacy@@',
    'terms' => '@@terms@@',
    ...
    '{site-title} will invite participants to share their availability and preferences time and place options so you don\'t have to.' => '@@{site-title} will invite participants to share their availability and preferences time and place options so you don\'t have to.@@',
    ...
    '(declined)' => '(declined)',
    '-' => '-',
    '...please sign up above...' => '...please sign up above...',
    '1) Sign up using one of these services:' => '1) Sign up using one of these services:',
    '1:1 Meeting and Activity Planning' => '1:1 Meeting and Activity Planning',
    '2) Choose your date and time:' => '2) Choose your date and time:',
    ...
    'As an organizer, you\'re allowed to suggest additional activities' => 'As an organizer, you\'re allowed to suggest additional activities',
    'As an organizer, you\'re allowed to suggest additional places' => 'As an organizer, you\'re allowed to suggest additional places',
    'As an organizer, you\'re allowed to suggest additional times' => 'As an organizer, you\'re allowed to suggest additional times',
    'As the event nears, participants receive regular reminders via email or text message. Reminders are fully customizable.' => 'As the event nears, participants receive regular reminders via email or text message. Reminders are fully customizable.',
    ...
    'Aug' => 'Aug',
    'Automatically add to your calendar' => 'Automatically add to your calendar',
    ...
    'Choose the date and time' => 'Choose the date and time',
    ...
    'Decide the date and time' => 'Decide the date and time',
    'Decide the place' => 'Decide the place',
    'Decline' => 'Decline',
    ...
    'Estimate' => 'Estimate',
    'Estimates by Day' => 'Estimates by Day',
    'Estimates by Month' => 'Estimates by Month',
    ...
    'Get started in seconds with any of these services:' => 'Get started in seconds with any of these services:',
    ...
    'If a friend referred you, they may be able to see your guess, but otherwise it will be displayed anonymously.' => 'If a friend referred you, they may be able to see your guess, but otherwise it will be displayed anonymously.',
    ...
    'It allows you to schedule future meetings and events with us (and it helps keep the trolls out).' => 'It allows you to schedule future meetings and events with us (and it helps keep the trolls out).',
    'It\'s fastest using these services:' => 'It\'s fastest using these services:',
    'Item ID' => 'Item ID',
    'Jan' => 'Jan',
    'Jeff Reifman' => 'Jeff Reifman',
    'Jeff helped lead the technology launch of MSNBC.com as part of an eight year career at Microsoft. He left Microsoft to found GiftSpot, later acquired by GiftCertificates.com. He’s a three time grantee of the John S. and James L. Knight Foundation. In 2009, he led the capture of missing writer Evan Ratliff in ' => 'Jeff helped lead the technology launch of MSNBC.com as part of an eight year career at Microsoft. He left Microsoft to found GiftSpot, later acquired by GiftCertificates.com. He’s a three time grantee of the John S. and James L. Knight Foundation. In 2009, he led the capture of missing writer Evan Ratliff in',
    ...
    'Launch' => 'Launch',
    'Launches' => 'Launches',
    'Learn more about Alex here' => 'Learn more about Alex here',
    'Learn more about Jeff here' => 'Learn more about Jeff here',
    'Level' => 'Level',
    'Like' => 'Like',
    ...
    'No more emails about which places might work. Suggest one or more via Google Places and we\'ll ask participants which they prefer. ' => 'No more emails about which places might work. Suggest one or more via Google Places and we\'ll ask participants which they prefer.',
    'No more emails about which times will work best. Suggest one or more times that work for your schedule in seconds and we\'ll ask participants about their availability.' => 'No more emails about which times will work best. Suggest one or more times that work for your schedule in seconds and we\'ll ask participants about their availability.',
    ...
    'Once you\'ve finalized the schedule, it\'s easy to add the event to your calendar, complete with links and a map.' => 'Once you\'ve finalized the schedule, it\'s easy to add the event to your calendar, complete with links and a map.',
    'Optional' => 'Optional',
    'Options' => 'Options',
    'Or, fill out the following fields to login:' => 'Or, fill out the following fields to login:',
    'Or, invite participants by sharing' => 'Or, invite participants by sharing',
    'Or, sign up with your email:' => 'Or, sign up with your email:',
    ...
    'Protest' => 'Protest',
    'Provide participant emails' => 'Provide participant emails',
    'Questions?' => 'Questions?',
    ...
    'Sorry, we do require your email address from Facebook. Either' => 'Sorry, we do require your email address from Facebook. Either',
    ...
    'Start' => 'Start',
    'Start instantly with any of these services:' => 'Start instantly with any of these services:',
    'Startup series' => 'Startup series',
    ...
    'Suggest meeting places' => 'Suggest meeting places',
    'Suggest meeting times' => 'Suggest meeting times',
    ...
    'There was a problem with your estimate.' => 'There was a problem with your estimate.',
    ...
    'We check availability' => 'We check availability',
    ...
    'We publish the schedule' => 'We publish the schedule',
    ...
    'We will let you know when it\'s time to plan your party!' => 'We will let you know when it\'s time to plan your party!',
    ...
    'We\'re asking people and charting everyone\'s guesses.' => 'We\'re asking people and charting everyone\'s guesses.',
    ...
    'When' => 'When',
    'When Congress finally acts, we\'ll help you plan your celebration.' => 'When Congress finally acts, we\'ll help you plan your celebration.',
    'When Do You Think Trump Will Be Impeached?' => 'When Do You Think Trump Will Be Impeached?',
    ...
    'When you\'re ready, finalize the time and location and we\'ll email details to everyone. You can also allow participants or designate additional organizers to make the final decisions.' => 'When you\'re ready, finalize the time and location and we\'ll email details to everyone. You can also allow participants or designate additional organizers to make the final decisions.',
    'Where' => 'Where',
    ...
    'You predict that Trump will be impeached on:' => 'You predict that Trump will be impeached on:',
    ...
    'Your timezone has been updated successfully. Refresh the page to see adjusted times.' => 'Your timezone has been updated successfully. Refresh the page to see adjusted times.',
    ...
    'active conference speaker' => 'active conference speaker',
    'add a note' => 'add a note',
    ...
    'and try again, or register using a different method below.' => 'and try again, or register using a different method below.',
    ...
    'remove us from your Facebook apps' => 'remove us from your Facebook apps',
    'removed place' => 'removed place',
    'removed time' => 'removed time',
    'reset your password' => 'reset your password',
    'review shared availability' => 'review shared availability',
    'review shared preferences' => 'review shared preferences',
    ...
    'to send messages to others' => 'to send messages to others',
    ...
    '{site-title} makes scheduling meetings easy' => '{site-title} makes scheduling meetings easy',
    '{site-title} will invite participants to share their availability and preferences for times and places so you don\'t have to.' => '{site-title} will invite participants to share their availability and preferences for times and places so you don\'t have to.',
    '{subject}' => '{subject}',
];