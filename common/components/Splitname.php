...
class FullNameParser {
  ...
  protected $dict = [
    ...
    'compound' => ['da','de','del','della','der','di','du','la','pietro','st.','st','ter','van','vanden','vere','von'],
    'suffixes' => [
      'line' => ['I','II','III','IV','V','1st','2nd','3rd','4th','5th','Senior','Junior','Jr','Sr'],
      'prof' => ['AO', 'B.A.', 'M.Sc', 'BCompt', 'PhD', 'Ph.D.','APR','RPh','PE','MD', 'M.D.', 'MA','DMD','CME', 'BSc', 'Bsc', 'BSc(hons)', 'Ph.D.', 'BEng', 'M.B.A.', 'MBA', 'FAICD', 'CM', 'OBC', 'M.B.', 'ChB', 'FRCP', 'FRSC',
  ...
  public function parse_name($full_name) {
    ...
    # Setup default vars
    extract(['salutation' => '', 'fname' => '', 'initials' => '', 'lname' => '', 'suffix' => '']);
